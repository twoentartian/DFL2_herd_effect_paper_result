...
folders = ["100_train_0_average", "98_train_2_average", "96_train_4_average", "94_train_6_average", "92_train_8_average", "50_train_50_average"]

titles = ["x=1", "x=0.98", "x=0.96", "x=0.94", "x=0.92", "x=0.5"]

maximum_tick = 10000
save_name = "model_updating_algorithm"
